  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        window.location.href = "/dashboard"; // Change this route to your actual dashboard
      } else {
          ...
          <div className="flex justify-center mb-4 md:mb-6">
            <div className="w-12 h-12 md:w-16 md:h-16 bg-cyan-100 rounded-full flex items-center justify-center">
              <svg
                ...
                className="h-6 w-6 md:h-8 md:w-8 text-cyan-600"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {!isLogin && (
                ...
                >
                  ...
                  <input
                    ...
                    placeholder="Your username"
                    className="w-full p-2 md:p-3 pl-10 border border-gray-200 rounded-lg focus:ring-2 focus:ring-cyan-300 focus:border-cyan-300 transition-all text-sm md:text-base"
                  />
                </motion.div>
              )}
              ...
              <motion.button
                type="submit"
                disabled={loading}
                className="w-full py-2 md:py-3 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-lg font-medium shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 text-sm md:text-base disabled:opacity-50"
                whileHover={{ scale: 1.01 }}
                whileTap={{ scale: 0.99 }}
              >
